module.exports.config = {
  ...
  module.exports.onReaction = async ({ api, event, Reaction, threadsData, usersData, commandName }) => {
  ...
  module.exports.onStart = async ({ api, event, args, client, commandName, __GLOBAL }) => {
    switch (args[0]) {
        case "on":
          if (!global.antispam) global.antispam = new Map();
