...
module.exports.config ={
  ...
  {p}{n}
  {p}{n} [2]
  {p}{n} [query] [indexNumber]
  {p}{n} add ['cartoon', 'photo', 'lofi', 'sad', 'islamic','funny','horny','anime','love','baby','lyrics','sigma','photo','aesthetic','cat','flower','ff','sex','girl','football','friend', 'cricket']
    `,
  },
},
